...
import 'package:loom/features/core/search/search_execution/data/providers.dart';
import 'package:loom/features/core/search/search_execution/domain/usecases/search_usecases.dart';
import 'package:loom/features/core/search/search_history/data/providers.dart';
import 'package:loom/features/core/search/search_history/domain/usecases/manage_recent_searches_usecase.dart'
    as history;
...
final manageRecentSearchesUseCaseProvider =
    Provider<history.ManageRecentSearchesUseCase>((ref) {
  final repository = ref.watch(recentSearchesRepositoryProvider);
  return history.ManageRecentSearchesUseCase(repository);
});
...
class SearchNotifier extends StateNotifier<SearchState> {
  ...
  final history.ManageRecentSearchesUseCase _manageRecentSearchesUseCase;
