...
class PluginUIApi {
  ...
  void registerSidebarItem(String pluginId, SidebarItem item) {
    // Use existing UIRegistry but track ownership
    _registry.registerComponent(pluginId, item.id);
    // TODO(user): Integrate with existing UIRegistry
  }
